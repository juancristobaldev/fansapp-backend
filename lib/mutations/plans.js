    ...
    const response = await isAuth(
      async (user) => {
        ...
        if (amount > 0) {
          ...
          yearlyPlan.amount = parseFloat((amount * 12 * 0.8).toFixed(2));
          ...
          if (discount > 0) {
            ...
            yearlyPlan.amountWithDiscount = (
              amount * 12 * 0.8 -
              totalAmountDiscountYearly
            ).toFixed(2);
            monthlyPlan.amountWithDiscount =
              amountMonthlyWithDiscount.toFixed(2);
          }
        }
