            ...
            return {
              ...
              posts: {
                ...
                users: {
                  ...
                  profile: {
                    ...post.users.profile,
                    photo: post.users.profile.photo
                      ? JSON.stringify(post.users.profile.photo)
                      : null,
                    frontPage: post.users.profile.frontPage
                      ? JSON.stringify(post.users.profile.frontPage)
                      : null,
                  },
                },
              },
